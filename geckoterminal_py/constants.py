...
GET_LATEST_POOLS_BY_NETWORK_PATH = "networks/{}/new_pools"
GET_LATEST_POOLS_ALL_NETWORKS_PATH = "networks/new_pools"

# Tokens
GET_TOP_POOLS_FOR_TOKEN_PATH = "networks/{}/tokens/{}/pools"
